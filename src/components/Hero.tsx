  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-background to-muted/30 pt-6 pb-10 md:pt-24 md:pb-20 px-10 sm:pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-5">
        ...
        <div className="absolute -left-20 top-40 h-[25rem] w-[25rem] rounded-full border-[1rem] border-primary/10"></div>
        ...
        {/* Engineering Symbols */}
        <div className="absolute right-10 top-40 h-32 w-32 opacity-20">
        ...
        <div className="absolute left-20 bottom-40 h-32 w-32 opacity-20">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M14 11H10V15H14V11Z"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
